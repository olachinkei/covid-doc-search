"""Evaluate a RetrievalQAWithSourcesChain on a dataset of questions and answers."""
import os
...
def generate_answers(
    eval_dataset: pd.DataFrame, qa_chain: RetrievalQAWithSourcesChain
) -> pd.DataFrame:
    """Generate answers for a dataset of questions and answers
    Args:
        eval_dataset (pd.DataFrame): A dataframe of questions and answers
        qa_chain (RetrievalQAWithSourcesChain): A RetrievalQAWithSourcesChain object
    Returns:
